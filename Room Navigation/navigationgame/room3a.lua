...
function T.load()
  doorl = makeDoor(1,0,1,0,true, false,true)
  doorc = makeDoor(1,.5,1,W/2-50,true,false,false)
  doorr = makeDoor(1,0,0,W-100,true, false,false)
...
function T.draw()
  for i = 1, #room do
    ...
    love.graphics.print("room3a",20,20)
